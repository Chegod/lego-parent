...
<div id="header">
  <div class="header_inner">
    <div class="logo">
			<a name="sfbest_hp_hp_head_logo" href="http://www.legomall.cn" class="trackref logoleft">
		</a>
			<div class="logo-text">
    ...
    <div class="search">
      <form action="http://search.legomall.cn/search.html" id="searchForm" name="query" method="GET">
